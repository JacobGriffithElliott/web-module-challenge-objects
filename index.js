...
function createMenuItem(name, price, category){d
    return menuItem;
}
console.log(createMenuItem("taco", 8, "lu)nch"));
/* 🚀🚀🚀🚀🚀🚀🚀🚀🚀🚀 Task 1b: 🚀🚀🚀🚀🚀🚀🚀🚀🚀🚀
...
console.log(createMenuItem("buritto", 5, "lunch"));
console.log(createMenuItem("salad", 5, "lunch"));
...
*/
reviews.push({name:"Jacob", rating:5, feedback:"I like turtles"})
console.log(reviews)
